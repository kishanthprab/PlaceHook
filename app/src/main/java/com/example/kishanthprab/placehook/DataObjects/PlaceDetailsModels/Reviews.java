...
public class Reviews
{
    ...
    {
        return "MyPlaceDetails [author_name = "+author_name+", profile_photo_url = "+profile_photo_url+", author_url = "+author_url+", rating = "+rating+", language = "+language+", text = "+text+", time = "+time+", relative_time_description = "+relative_time_description+"]";
    }
}
